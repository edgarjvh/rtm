            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        Register under an organization or <a href="/register">click here</a> to register your own
                        organization
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row mt-2">
                                <label class="col-md-6 offset-md-4 control-label">Or Register With</label>
                                <div class="row">
                                </div>
                                <div class="col-md-6 offset-md-4">
